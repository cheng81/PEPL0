  ...
  var result = {
    ...
    parse: function(input, startRule) {
          ...
          if (result27 !== null) {
            ...
            if (result28 !== null) {
              ...
              if (result32 !== null) {
                ...
                if (result33 !== null) {
                  var result34 = parse_constraint();
                  if (result34 !== null) {
                    var result30 = [result32, result33, result34];
                  } else {
                    var result30 = null;
                    pos = savedPos9;
                  }
              ...
              var result31 = result30 !== null
                ? (function(c) {return c})(result30[2])
                : null;
              if (result31 !== null) {
              ...
              if (result5 !== null) {
                ...
                if (result6 !== null) {
                  ...
                  if (result7 !== null) {
                    ...
                    var result19 = result18 !== null
                      ? (function(m) {return m})(result18[2])
                      : null;
                    if (result19 !== null) {
                      var result17 = result19;
                    } else {
                    ...
                    if (result8 !== null) {
                      ...
                      if (result9 !== null) {
                        ...
                        var result13 = result12 !== null
                          ? (function(c) {return c})(result12[2])
                          : null;
                        if (result13 !== null) {
        ...
        if (result3 !== null) {
          ...
          if (result4 !== null) {
            ...
            if (result9 !== null) {
              var result10 = parse__();
              if (result10 !== null) {
                var result11 = parse_iscondition();
                if (result11 !== null) {
        ...
        if (result3 !== null) {
          ...
          if (result4 !== null) {
            ...
            if (result9 !== null) {
              var result10 = parse__();
              if (result10 !== null) {
                var result11 = parse_ismilestone();
                if (result11 !== null) {
                  var result7 = [result9, result10, result11];
                } else {
                  var result7 = null;
      ...
      function parse_constraint() {
        ...
        var result2 = result1 !== null
          ? (function(bexpr) {return bexpr})(result1)
          : null;
        if (result2 !== null) {
          var result0 = result2;
        } else {
      ...
      function parse_boolexpr() {
        ...
        if (result26 !== null) {
          ...
          if (result27 !== null) {
            ...
            if (result28 !== null) {
              ...
              if (result29 !== null) {
                var result30 = parse_boolexpr();
                if (result30 !== null) {
                  var result31 = parse__();
                  if (result31 !== null) {
                    var result32 = parse_boolexpr();
                    if (result32 !== null) {
                      var result33 = parse__();
                      if (result33 !== null) {
                        if (input.substr(pos, 1) === ")") {
                        ...
                        if (result34 !== null) {
                          var result24 = [result26, result27, result28, result29, result30, result31, result32, result33, result34];
                        } else {
                          var result24 = null;
                          pos = savedPos5;
                        }
        ...
        var result25 = result24 !== null
          ? (function(andor, fst, snd) {
          	...
          	})(result24[2], result24[4], result24[6])
          : null;
        if (result25 !== null) {
      ...
      function parse_ismilestone() {
            ...
            if (result16 !== null) {
              ...
              if (result17 !== null) {
                ...
                var result27 = result26 !== null
                  ? (function(p) {return p})(result26[0])
                  : null;
                if (result27 !== null) {
                    ...
                    if (result20 !== null) {
                      ...
                      if (result21 !== null) {
                        ...
                        if (result22 !== null) {
                          ...
                          if (result23 !== null) {
                            var result12 = [result14, result15, result16, result17, result18, result19, result20, result21, result22, result23];
                          } else {
                            var result12 = null;
                            pos = savedPos3;
                          }
        ...
        var result13 = result12 !== null
          ? (function(path, evid, vals) {
          	...
          	})(result12[4], result12[5], result12[7])
          : null;
        if (result13 !== null) {
          var result11 = result13;
        } else {
      ...
      function parse_value() {
        ...
        if (result9 !== null) {
          ...
          if (result8 !== null) {
            ...
            var result7 = parse_varload();
            if (result7 !== null) {
              var result3 = result7;
            } else {
              var result6 = parse_unifvar();
              if (result6 !== null) {
                var result3 = result6;
              } else {
      ...
      function parse_unifvar() {
        var cacheKey = 'unifvar@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        var result2 = result1 !== null
          ? (function(name) {return {type:'uvar',val:name}})(result1[1])
          : null;
        if (result2 !== null) {
          var result0 = result2;
        } else {
      ...
      function parse_predicate() {
        ...
        if (result7 !== null) {
          ...
          var savedPos1 = pos;
          var result5 = parse_unifvar();
          var result6 = result5 !== null
            ? (function(v) {return gactions.makeUnificationPredicate(v)})(result5)
            : null;
          if (result6 !== null) {
            var result4 = result6;
          } else {
